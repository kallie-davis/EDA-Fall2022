...
print(Plot_text) #curly brackets so all values are added as superscript
...
ex.3 <- ggplot(EPAair, aes(x=PM2.5, y=Ozone))+
...
ex.4 <- ggplot(EPAair, aes(x=Month, y=PM2.5, color=Year))+
  scale_x_continuous(limits=c(1,12), breaks=c(1,12))+
  geom_point()
print(ex.4)

ex.4.1 <- ggplot(EPAair, aes(x=as.factor(Year), y=PM2.5))+
  geom_boxplot()
print(ex.4.1)

ex.4.2 <- ggplot(EPAair, aes(x=Month, y=PM2.5))+
  geom_point()+
