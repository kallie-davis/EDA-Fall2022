...
# Relative file path (friendly for users regardless of machine); add ", stringsAsFactors = TRUE" at the end of read.csv (e.g., read.csv("./Data/Raw/USGS_Site02085000_Flow_Raw.csv"), stringsAsFactors = TRUE)
