...
O3plot2 <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone, color = "blue")) #adds layer to the default if you change the color in the aesthetics. To actually change the color put it outside aes. 
...
Nutrientplot3 <-
  ...
  geom_boxplot(aes(color = nutrient)) # Why didn't we use "fill"? Color is the contour of the shape and fill is the filling of the shape
print(Nutrientplot3)
...
Nutrientplot5 <-
  ggplot(PeterPaul.chem.nutrients.gathered, aes(x = lakename, y = concentration)) +
  geom_violin(aes(color = nutrient)) #you can see the density in a violin plot
print(Nutrientplot5)
