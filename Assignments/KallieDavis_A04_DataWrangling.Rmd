...
#5
EPAair_PM25_NC2018$AQS_PARAMETER_DESC <- (EPAair_PM25_NC2018$AQS_PARAMETER_DESC="PM2.5") %>% 
  as.factor()
  
EPAair_PM25_NC2019$AQS_PARAMETER_DESC <- (EPAair_PM25_NC2019$AQS_PARAMETER_DESC="PM2.5") %>% 
  as.factor()
...
```{r}
#7
EPAair_O3_PM25_1819 <- rbind(EPAair_O3_NC2018, EPAair_O3_NC2019, EPAair_PM25_NC2018, EPAair_PM25_NC2019)

#8
EPAair_O3_PM25_1819_filtered <- EPAair_O3_PM25_1819 %>% 
...
#9
EPAair_03_PM25_1819_spread <- pivot_wider(EPAair_O3_PM25_1819_filtered, names_from =AQS_PARAMETER_DESC, values_from = DAILY_AQI_VALUE)

#10
dim(EPAair_03_PM25_1819_spread)

#11
write.csv(EPAair_03_PM25_1819_spread, row.names = FALSE, file = "../Data/Processed/EPAair_O3_PM25_NC1718_Processed.csv")
```
...
```{r}
#12a
EPAair_03_PM25_NC1718_summary <- EPAair_03_PM25_1819_spread %>% 
  group_by(Site.Name, Month, Year) %>% 
  dplyr::summarise(Mean_Ozone = mean(Ozone), Mean_PM2.5 = mean(PM2.5)) 

#12b
EPAair_03_PM25_NC1718_summary_drop.na <- EPAair_03_PM25_NC1718_summary %>% 
  drop_na(Mean_Ozone, Mean_PM2.5)

#13
dim(EPAair_03_PM25_NC1718_summary_drop.na)

```

14. Why did we use the function `drop_na` rather than `na.omit`?

> Answer: drop_na removes rows which contain missing values in specified columns in the dataset; it is part of the tidyr package in R. na.omit removes rows which contain missing values in any column. 
